...
export class AhorcadoComponent {
  ...
  private palabras: string[] = [
    'AHORCADO', 'COMPUTADORA', 'TELEFONO', 'ELEFANTE', 'GIRASOL', 'PARAGUAS', 'HELICOPTERO', 'CHOCOLATE', 'BICICLETA', 'VENTANA',
    'ESPEJO', 'LIBRERIA', 'CANGURO', 'MARIPOSA', 'TELEVISOR', 'REFRIGERADOR', 'PANTALON', 'ZAPATILLA', 'SILLON', 'LAMPARA',
    'GALLETA', 'JIRAFA', 'PINGUINO', 'CASCADA', 'MONTANA', 'OCEANO', 'PLATANO', 'NARANJA', 'MANZANA', 'SANDIA',
    'GLOBO', 'COHETE', 'AVION', 'TREN', 'BARCO', 'PIZARRA', 'CUADERNO', 'LAPIZ', 'BORRADOR', 'REGLA',
    'ESCUELA', 'HOSPITAL', 'BIBLIOTECA', 'RESTAURANT', 'SUPERMERCADO', 'DOCTOR', 'MAESTRO', 'INGENIERO', 'MUSICO', 'ARTISTA',
    'FUTBOL', 'BASQUETBOL', 'TENIS', 'NATACION', 'CICLISMO', 'PIANO', 'GUITARRA', 'TAMBOR', 'VIOLIN', 'FLAUTA',
    'PINTURA', 'ESCULTURA', 'FOTOGRAFIA', 'CINE', 'TEATRO', 'JARDIN', 'JARDINERO', 'FLORES', 'ARBOLES', 'PLANTAS',
    'LLUVIA', 'TORMENTA', 'ARCOIRIS', 'NIEVE', 'VIENTO', 'DESIERTO', 'JUNGLA', 'SABANA', 'BOSQUE', 'PLAYA', 'VOLCAN',
    'TERREMOTO', 'HURACAN', 'TORNADO', 'INUNDACION', 'DINOSAURIO', 'FOSIL', 'MUSEO', 'HISTORIA', 'GEOGRAFIA',
    'QUIMICA', 'FISICA', 'MATEMATICA', 'BIOLOGIA', 'ASTRONOMIA', 'GALAXIA', 'PLANETA', 'ESTRELLA', 'COMETA', 'METEORITO',
    'CASTILLO', 'DONCELLA', 'CABALLERO', 'DRAGON', 'MAGIA', 'HADA', 'DUENDE', 'BRUJA', 'HECHIZO', 'VARITA', 'PIRATA', 'TESORO',
    'ISLA', 'MAPA', 'BARCO', 'ROBOT', 'COMPUTADOR', 'INTERNET', 'PROGRAMACION', 'ALGORITMO', 'CELULAR', 'CAMARA', 'MICROFONO', 'AURICULAR', 'ALTAVOZ',
    'RELOJ', 'CALENDARIO', 'AGENDA', 'DIRECTORIO', 'ENCICLOPEDIA', 'DICCIONARIO', 'NOVELA', 'POESIA', 'CUENTO', 'HISTORIETA',
    'PALOMITAS', 'HELADO', 'CHOCOLATE', 'CARAMELO', 'PASTEL', 'GALLETA', 'PANQUEQUE', 'WAFFLE', 'JUGUETE', 'MUÑECA',
    'PELOTA', 'ROMPECABEZAS', 'LEGO', 'CONSOLA', 'VIDEOJUEGO', 'BALON', 'RED', 'CANCHA', 'ARCO', 'JUEGO',
    'RAQUETA', 'PELOTA', 'GUANTE', 'CASCO', 'UNIFORME', 'MEDALLA', 'TROFEO', 'PODIO', 'COMPETENCIA', 'CAMPEONATO',
    'EJERCICIO', 'GIMNASIO', 'PESAS', 'YOGA', 'PILATES', 'CORRER', 'SALTAR', 'NADAR', 'BAILAR', 'ESCALAR',
    'VIAJAR', 'EXPLORAR', 'AVENTURA', 'SENDERISMO', 'CAMPING', 'FOGATA', 'CARPA', 'MOCHILA', 'CANTIMPLORA', 'BINOCULARES',
    'PINCEL', 'ACUARELA', 'OLEO', 'CARBONCILLO', 'ACRILICO', 'ESCENARIO', 'ACTUACION', 'DIRECTOR', 'GUION', 'PRODUCCION',
